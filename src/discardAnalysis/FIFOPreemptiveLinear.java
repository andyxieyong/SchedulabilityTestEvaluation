...
// ArrayList<Resource> resources, boolean printBebug, boolean printLIP) {
...
// if (printBebug) {
// if (missDeadline)
// System.out.println("LIPFIFONP after " + count + " tims of recursion, the
// tasks miss the deadline.");
// else
// System.out.println("LIPFIFONP after " + count + " tims of recursion, we got
// the response time.");
...
// ArrayList<Resource> resources, long[][] response_time, boolean printBebug) {
...
// boolean printDebug) {
// generateObjective(task, tasks, resources, task.variables, task.objective,
// task.coefficient);
//
// constraintOne(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables);
// constraintTwo(task, tasks, resources, task.fixed_constraints_eq,
// task.fixed_values_eq, task.variables);
// constrainThree(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables);
// constrainFour(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables, task.binary_index);
// constrainFive(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables);
// constrainSix(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables);
// constrainSeven(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables);
// constrainTen(task, tasks, resources, task.fixed_constraints_neq,
// task.fixed_values_neq, task.variables);
// }
//
...
//
// constrainElevenTwelve(task, tasks, resources, constraints_neq, values_neq,
// task.variables, Ris, Ri);
// constrainThirteen(task, tasks, resources, constraints_neq, values_neq,
// task.variables, Ris, Ri);
//
// printLIP(task.objective, task.coefficient, constraints_neq, values_neq,
// task.fixed_constraints_eq, task.fixed_values_eq, task.variables,
// task.binary_index, printDebug);
//
//// double[] blocking = new Utils().sloveMIP(task.objective, task.coefficient,
// constraints_neq, values_neq, task.fixed_constraints_eq, task.fixed_values_eq,
// task.variables,
//// task.binary_index, printDebug);
//
// return null;
// }
//
// public void generateObjective(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
...
//
// String variable1 = other_task.id - 1 + "|" +
// other_task.resource_required_index.get(k) + "|" + l + "|" + "SD";
// String variable2 = other_task.id - 1 + "|" +
// other_task.resource_required_index.get(k) + "|" + l + "|" + "LB";
//
...
// }
//
// public void constraintOne(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
...
// }
//
// public void constraintTwo(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_eq,
...
// }
//
// public void constrainThree(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables) {
//
...
// }
//
// public void constrainFour(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables,
// ArrayList<Integer> binary_index) {
//
// ArrayList<Integer> constrain = new ArrayList<>();
//
// for (int i = 0; i < resources.size(); i++) {
...
// }
//
// int variable_index = addGetVariable(variables, 0 + "|" + (resource.id - 1) +
// "|" + 0 + "|" + "PR");
...
// }
//
// public void constrainFive(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables) {
// ArrayList<Integer> constrain = new ArrayList<>();
...
// String variable = lhp_task.id - 1 + "|" +
// lhp_task.resource_required_index.get(j) + "|" + k + "|" + "LB";
...
// }
//
// public void constrainSix(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables) {
// ArrayList<Integer> constrain = new ArrayList<>();
...
// String variable = other_task.id - 1 + "|" +
// other_task.resource_required_index.get(j) + "|" + k + "|" + "SD";
// constrain.add(addGetVariable(variables, variable));
// }
// }
// }
...
// task.priority) {
// for (int k = 0; k <
// other_task.number_of_access_in_one_release.get(other_task.resource_required_index.indexOf(resource.id
// - 1)); k++) {
...
// }
//
// public void constrainTen(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables) {
...
// }
//
// public void constrainElevenTwelve(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables, long[][] Ris,
// long Ri) {
//
// ArrayList<Integer> constrain = new ArrayList<>();
// for (int k = 0; k < resources.size(); k++) {
...
// }
//
// public void constrainThirteen(SporadicTask task,
// ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources,
// ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq, ArrayList<String> variables, long[][] Ris,
// long Ri) {
...
// }
//
// public int getMaxPreemption(SporadicTask task, ArrayList<SporadicTask> tasks,
// long Ri) {
...
// number_of_request_by_HP += Math.ceil((double) (Ri +
// (use_deadline_insteadof_Ri ? hpTask.deadline : Ris[i])) / (double)
// hpTask.period)
...
// }
//
// public void printLIP(ArrayList<Integer> objective, ArrayList<Integer>
// coefficient, ArrayList<ArrayList<Integer>> constraints_neq,
// ArrayList<Integer> values_neq,
// ArrayList<ArrayList<Integer>> constraints_eq, ArrayList<Integer> values_eq,
// ArrayList<String> variables, ArrayList<Integer> binary_index, boolean
// printDebug) {
// if (printDebug) {
...
// System.out.println("variable index: " + binary_index.get(i) + " variable: " +
// variables.get(binary_index.get(i)));
// }
//
