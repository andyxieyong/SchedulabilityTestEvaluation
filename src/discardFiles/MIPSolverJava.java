...
// GLPK.glp_set_row_bnds(lp, constrain_num + 1, GLPKConstants.GLP_UP, 0,
// values_neq.get(constrain_num));
//
...
// GLPK.glp_set_row_bnds(lp, constrain_num + 1, GLPKConstants.GLP_FX, 0,
// values_eq.get(i));
//
...
// GLPK.doubleArray_setitem(val, j + 1, value);
// }
// GLPK.glp_set_mat_row(lp, constrain_num + 1, constraints_eq.get(i).size(),
// ind, val);
// constrain_num++;
// }
//
