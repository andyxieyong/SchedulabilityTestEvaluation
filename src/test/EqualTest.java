...
public class EqualTest {
	...
	public static int TOTAL_PARTITIONS = 15;
...
//		FIFONPLinearJava fnp = new FIFONPLinearJava();
		...
		for (int i = 0; i < TOTAL_NUMBER_OF_SYSTEMS; i++) {
			...
			r1 = mrsp.NewMrsPRTATest(tasks, resources, false);
			System.out.println(i);
			r2 = s_mrsp.NewMrsPRTATest(tasks, resources, false,0,false);
			System.out.println(i + "*");
			...
			if (!isEqual) {
				...
				r1 = mrsp.NewMrsPRTATest(tasks, resources, true);
				r2 = s_mrsp.NewMrsPRTATest(tasks, resources, false, 0 ,true);
				System.exit(0);
			}
